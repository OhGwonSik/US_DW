...
public class CustomAuthenticationFailureHandler extends SimpleUrlAuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
		...
		if (compkey != null) {
			userService.insertLoginUser(compkey, useract, warekey, loginip, secchua, secchmb, secchpf, haccept, navplat,
					navvers, loginsf);
		}
		...
		// String msg = messageSource.getMessage("sy.main.login.loginfalse", null,
		// langkey );
