...
public class UserVO implements UserDetails {
   ...
   private String warekey; // VARCHAR(20) Warekey 2023.10.17 추가
   private String waredky; // VARCHAR(20) Warekey 2023.10.27 추가 default warekey
   ...
   private String rgropid; // VARCHAR(50) US_OP.OP_WH_ROLE_GROUP TABLE //2023.10.17 추가
   ...
   // public void setUserRoleVOList(List<UserRoleProgramDTO> userRoleVOList) { /*
   // 사용안함 map*/
