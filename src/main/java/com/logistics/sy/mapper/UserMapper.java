...
public interface UserMapper { 
	...
	List<UserVO> selectVUserList(UserVO userVO);
	...
	//사용자 메뉴 : 즐겨찾기
	int insertCompanyUserMenuBookmark(Map<String, Object> map);
	int deleteCompanyUserMenuBookmark(Map<String, Object> map);
	
	// 회원가입 : 유저등록
	int insertOneUser(UserDTO userDTO);
	
	List<Map<String,String>> selectWarekey(); //pda로그인화면 창고 리스트 불러오기 (추가 오권식) 2023-08-02

	Map<String, Object> getMenuInfo(String param);
