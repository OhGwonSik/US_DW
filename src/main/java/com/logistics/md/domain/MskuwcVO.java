...
@Setter
@ToString
public class MskuwcVO {
	/*
	 * ********************************************
	  - DTO Name   : MskuwcDTO
	  - Description    : 부품등록 wc 마스터 테이블
	  - Made By        : Park T. S.
	...
	*/
	...
	private String skugr01; // VARCHAR(20) - SKU Group 1 보관온도
	private String skugr02; // VARCHAR(20) - SKU Group 2 대분류
	private String skugr03; // VARCHAR(20) - SKU Group 3 중분류
	private String skugr04; // VARCHAR(20) - SKU Group 4 소분류
