	...
	json.forEach((item)=>{
	    ...
	    if(valMenulvl != 0  ) {	 
	    	if(menugbn =='FLD' ){
				addDHtml += "<details> ";
				addDHtml += "<summary> ";
				addDHtml += "<div class='submenu-title'><img class='"+menuico+"'>"+menunam+"</div>";
				addDHtml += "<img class='ic-submenu-open'>";
				addDHtml += "</summary> ";
				addDHtml += "<ul class='details-submenu'>  ";
