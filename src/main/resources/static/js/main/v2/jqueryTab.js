...
$(document).ready(function() {
	...
	$(document).on( "click", "#tabs img.remove", function( ) {
    	// Get the tab name
...
function addTab(gprogcmd, gprogrid, gnatitle, gcontent, gprodata) {
    ...
    if ($("#" + gprogrid).length != 0) { 
		...
		$("#" + gprogrid + "_content").load(rPath + '/main/tabPageCMD.do'+'?gprogrid='+gprogrid+'&gprogcmd='+gprogcmd+'&gnatitle='+encodeURI(gnatitle)+'&gprodata='+encodeURI(gprodata) );
        return;
    }
    ...
    $("#tabs").prepend("<li id='tabli_"+gprogrid+"' class='tab-menu' ><img class='ic-bookmark'><a class='tab' id='" + gprogrid + "'  href='#' title='"+ gnatitle + "' >" + gshtitle + "</a><img class='ic-tab-close remove'></li>");
	$("#content .content-wrapper").append("<px id='" + gprogrid + "_content'>" + gcontent + "</px>");
    $("#" + gprogrid + "_content").load(rPath + '/main/tabPageCMD.do'+'?gprogrid='+gprogrid+'&gprogcmd='+gprogcmd+'&gnatitle='+encodeURI(gnatitle)+'&gprodata='+encodeURI(gprodata) );
