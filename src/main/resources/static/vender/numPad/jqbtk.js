...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        var onKeypress = function(e) {
			...
			parent[0].closest('tr').querySelector('input[type="checkbox"]').checked || (parent[0].closest('tr').querySelector('input[type="checkbox"]').checked =  true);
            keyboardShiftify();
            parent.focus();
        };
        ...
        return this.each(function() {
            $(this).popover({
                content: function() {
                    ...
                    // Set up container
                    var content = $('<div class="jqbtk-container left-arrow" tabIndex="-1">');
                        ...
                        $.each(line, function() {
                            ...
                            switch (this[0]) {
                                ...
                                case 'space':
                                    ...
                                    break;
                                case 'del':
                                    btn.addClass('jqbtk-del').html('<span class="glyphicon glyphicon-arrow-left"><img src="' + rPath +'/v1/assets/ic_tab_arrow_left_w.png"></span>');
                                    break;
                                case 'enter':
                ...
                shown: function(){
					updateTailPosition($(this.element));
				},  
                html: true,
